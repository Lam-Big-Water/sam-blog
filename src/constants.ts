...
export interface ColorTheme {
  ...
  '--color-decorative-100': string;
  '--color-decorative-200': string;
  '--color-decorative-300': string;
  '--color-decorative-500': string;
  '--color-decorative-600': string;
  '--color-decorative-700': string;
  '--color-decorative-800': string;
  '--color-decorative-900': string;
  '--color-gray-0': string;
...
export interface DesignTokens extends ColorTheme, ShadowTheme {}
...
// 阴影定义
export const LIGHT_SHADOWS: ShadowTheme = {
  '--shadow-page': `
...
export const DARK_SHADOWS: ShadowTheme = {
  '--shadow-page': 'none',
  '--shadow-card': 'none',
};
...
// 主题配置映射
export const THEMES: Record<Theme, DesignTokens> = {
  light: LIGHT_TOKENS,
  dark: DARK_TOKENS,
};

// 工具函数
export const getThemeTokens = (theme: Theme): DesignTokens => THEMES[theme];
